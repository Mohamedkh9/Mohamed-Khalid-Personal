  ...
  return (
    <section id="home" className="min-h-[85vh] flex flex-col justify-center items-center pt-28 pb-10 scroll-mt-28">
      <div className="w-full max-w-7xl px-4 animate-fade-in-up">
        {/* Container - Adaptive Padding for Mobile */}
        <div className="border-2 border-accent p-6 md:p-12 lg:p-16 relative bg-white/30 backdrop-blur-sm rounded-none md:rounded-lg mx-auto max-w-6xl transition-all hover:shadow-lg">
          
          {/* Changed grid to 2 columns for better alignment and spacing */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-start">
               ...
               {/* Hero Typography */}
               <h1 className="font-serif text-primary leading-[1.1] mb-8">
                 <span className="block text-4xl md:text-5xl mb-2 font-medium opacity-90">{t.hello}</span>
                 <div className="flex flex-col md:flex-row items-center lg:items-start justify-center lg:justify-start gap-2 md:gap-3 flex-wrap">
                    ...
                    {lastName && (
                      <span className="block text-5xl md:text-7xl lg:text-8xl font-bold text-primary">
               ...
               {/* Restructured paragraph width to prevent visual overlap */}
               <p className="text-lg md:text-xl text-gray-500 mb-10 w-full max-w-lg leading-relaxed font-light">
                 {profile.bio}
               </p>
               ...
               <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                 <a 
                   href="#"
                   className="group border border-gray-200 hover:border-primary text-gray-700 hover:text-primary px-8 py-3.5 rounded-full font-semibold transition-all duration-300 flex items-center gap-2 bg-white"
                 >
            ...
            {/* Right Column: Profile Image (Order 1 on mobile, 2 on desktop) */}
              ...
              <div className="relative group">
                <div className="w-64 h-64 md:w-80 md:h-80 lg:w-[450px] lg:h-[450px] relative z-10">
                   <img 
                     ...
                     alt={profile.name}
                     className="w-full h-full object-cover rounded-full lg:rounded-[3rem] shadow-2xl border-4 border-white grayscale hover:grayscale-0 transition-all duration-500"
